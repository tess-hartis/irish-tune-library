...
{
    public partial class languageext : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TuneId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tunes_AlternateTitles", x => new { x.TuneId, x.Id });
                    table.ForeignKey(
                        name: "FK_Tunes_AlternateTitles_Tunes_TuneId",
                        column: x => x.TuneId,
                        principalTable: "Tunes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
