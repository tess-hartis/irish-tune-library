    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FeaturedOnId = table.Column<int>(type: "integer", nullable: false),
                    TuneListId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrackTune", x => new { x.FeaturedOnId, x.TuneListId });
                    table.ForeignKey(
                        name: "FK_TrackTune_Tracks_FeaturedOnId",
                        column: x => x.FeaturedOnId,
